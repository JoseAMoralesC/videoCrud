...
@section('content_header')
    <h1>{{__('Editar peliculas. Lista actores')}}</h1>
@stop
    ...
    <div class="card card-info card-outline card-outline-tabs">
        <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-actors-tab" data-toggle="pill" href="{{ route('movies.editActorList', $movie->id) }}" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">{{ __('Actores') }}</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card card-body">
            ...
            <div class="tab-pane fade show active" id="custom-tabs-three-actors" role="tabpanel" aria-labelledby="custom-tabs-three-actors-tab">
                <ul>
            ...
            <div class="tab-pane fade show active" id="custom-tabs-three-genres" role="tabpanel" aria-labelledby="custom-tabs-three-genres-tab"></div>
        </div>
    </div>
@stop
